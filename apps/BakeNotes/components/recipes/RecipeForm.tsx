              ...
              >
                ...
                <View className="flex-row gap-2">
                  <TextInput
                    ...
                    placeholderTextColor={placeholderTextColor}
                    keyboardType="numeric"
                    className="flex-1 rounded-[12px] border border-[#eadfce] bg-[#fffaf5] px-3 py-2 text-[13px] text-[#2d1f12]"
                  />
                  <TextInput
                    value={stage.bottomC}
                    onChangeText={(value) =>
                ...
                <View className="mt-2 flex-row gap-2">
                  <TextInput
                    ...
                    placeholderTextColor={placeholderTextColor}
                    keyboardType="numeric"
                    className="w-[90px] rounded-[12px] border border-[#eadfce] bg-[#fffaf5] px-3 py-2 text-[13px] text-[#2d1f12]"
                  />
                  <TextInput
                    value={stage.mode}
                    onChangeText={(value) =>
            ...
            tips.map((tip, index) => (
              <View key={`tip-${index}`} className="mb-3">
                ...
                <View className="flex-row items-center gap-2">
                  ...
                  <Pressable
                    onPress={() =>
                      setTips((prev) => prev.filter((_, idx) => idx !== index))
                    }
                    className="h-9 w-9 items-center justify-center rounded-full bg-[#fcecec]"
                  >
                    <MaterialIcons name="close" size={16} color={deleteIconColor} />
